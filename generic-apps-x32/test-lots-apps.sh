...
if [ ! -e Debugging-S3-S4.odp ]; then
	wget http://zinc.canonical.com/~cking/presentations/kernel-debugging/Debugging-S3-S4.odp
fi
...
# Run the tests...
#
$SENDTAG $LOG_HOST $TAGPORT "TEST_RUN_BEGIN Generic Applications: LibreOffice"
libreoffice ./Debugging-S3-S4.odp  &
sleep 60
$SENDTAG $LOG_HOST $TAGPORT "TEST_RUN_END Generic Applications: LibreOffice"
$SENDTAG $LOG_HOST $TAGPORT $(get_mem_stats)

$SENDTAG $LOG_HOST $TAGPORT "TEST_RUN_BEGIN Generic Applications: Firefox"
...
sleep 45
$SENDTAG $LOG_HOST $TAGPORT "TEST_RUN_END Generic Applications: Firefox"
$SENDTAG $LOG_HOST $TAGPORT $(get_mem_stats)

$SENDTAG $LOG_HOST $TAGPORT "TEST_RUN_BEGIN Generic Applications: Thunderbird"
thunderbird &
sleep 60
$SENDTAG $LOG_HOST $TAGPORT "TEST_RUN_END Generic Applications: Thunderbird"
$SENDTAG $LOG_HOST $TAGPORT $(get_mem_stats)
